...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        #circle with orient
        # pos =[ 0.3 + amplitude_x*sin(omega*t.to_sec()), (0.12 + amplitude_y) - amplitude_y*cos(omega*t.to_sec()), -amplitude_theta*sin(2*omega*t.to_sec())]
        ...
        #Circle no orient
        pos =[ 0.3 + amplitude_x*sin(omega*t.to_sec()), (0.12 + amplitude_y) - amplitude_y*cos(omega*t.to_sec()), 0]
