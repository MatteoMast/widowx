...
MX_TORQUE_STEPS = 1023

#MX-28 max torque
MX28_MAX_TORQUE = 2.5
MX28_TORQUE_UNIT = MX_TORQUE_STEPS/MX28_MAX_TORQUE
MX28_MAX_TORQUE_LIMIT = int(MX_TORQUE_STEPS/5)
#MX-64 max torque
MX64_MAX_TORQUE = 6.0
MX64_TORQUE_UNIT = MX_TORQUE_STEPS/MX64_MAX_TORQUE
MX64_MAX_TORQUE_LIMIT = int(MX_TORQUE_STEPS/5)
MX64_CURRENT_UNIT = 0.0045
MX64_K = 0.67
MX64_P = 0.2191
